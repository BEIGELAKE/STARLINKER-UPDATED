  ...
  return (
    <div className="relative h-[600px] flex items-center">
      <div 
        ...
        style={{
          backgroundImage: 'url(https://images.unsplash.com/photo-1465487862947-ded619a2a9ab?auto=format&fit=crop&q=80)',
      ...
      <div className="container mx-auto px-4 z-10">
        <div className="max-w-2xl">
          ...
          <p className="text-xl md:text-2xl mb-8">Professional Starlink Installation & Configuration Services</p>
          <Link 
            to="/book" 
